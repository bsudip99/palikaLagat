...
<head>
  ...
  <title>Palika lagat | Forgot Password </title>
      ...
      <div class="card-body login-card-body">
        <div class="mb-2 text-center">
          ...
          <div class="login-logo">
            <a href="{{ route('admin.login') }}" class="login-box-msg" style="font-size:50%;"><b>Palika lagat </b></a>
          </div>
        </div>
        <h1 class="text-center"> Update Password </h1>

        <form action="{{route('user.reset_password')}}" method="POST" id="change-password-form">
          @csrf
